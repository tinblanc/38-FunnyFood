...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor]}]; // set màu chữ navigation bar
    [[UINavigationBar appearance] setBarTintColor:[[UIColor alloc] initWithHex:@"ce3740" alpha:1.0]]; // set background Navigation Bar
    ...
    [[UINavigationBar appearance] setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys:
                                                           ...
                                                           [UIFont fontWithName:@"arial rounded mt bold" size:19], NSFontAttributeName, nil]];
